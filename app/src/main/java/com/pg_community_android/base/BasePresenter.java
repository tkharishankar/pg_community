...
import com.pg_community_android.data.network.model.ApiError;
 ...
 */
public class BasePresenter<V extends CommonView> implements CommonPresenter<V> {
    ...
    public static class MvpViewNotAttachedException extends RuntimeException {
        public MvpViewNotAttachedException() {
            super("Please call Presenter.onAttach(CommonView) before" +
