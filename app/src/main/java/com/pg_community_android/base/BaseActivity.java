...
import com.pg_community_android.di.component.ActivityComponent;
import com.pg_community_android.di.component.DaggerActivityComponent;
...
import com.pg_community_android.utils.NetworkUtils;
...
public abstract class BaseActivity extends AppCompatActivity
        implements CommonView, BaseFragment.Callback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActivityComponent = DaggerActivityComponent.builder()
                ...
                .applicationComponent(((PgApplication) getApplication()).getComponent())
                .build();
